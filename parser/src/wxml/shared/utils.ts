...
export function isTrue (v: true): boolean {
  return v === true
}

export function isFalse (v: false): boolean {
  return v === false
}
...
function polyfillBind (fn: Function, ctx: any) {
...
function nativeBind (fn: Function, ctx: any) {
  return fn.bind(ctx)
}
 ...
 */
export function genStaticKeys (modules: any) {
  return modules.reduce((keys: any, m: any) => {
